 ...
 */
class CMLProductImageCreateProcessor extends modObjectCreateProcessor {
    public $classKey = 'CMLProductImage';
    public $languageTopics = array('commerce_multilang:default');
    public $objectType = 'commerce_multilang.product_image';
    ...
    public function beforeSave() {
        ...
        if (empty($title)) {
            $this->addFieldError('title',$this->modx->lexicon('commerce_multilang.err.product_image_title_ns'));
        }
        $count = $this->modx->getCount('CMLProductImage',array(
...
return 'CMLProductImageCreateProcessor';
