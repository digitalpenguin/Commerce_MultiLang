 ...
 * Event: onModxInit
 *
 * This will load any variation columns on the commercemultilang_product_languages table into xPDO
 * Class: CommerceMultiLangProductLanguage
 *
 * Any columns loaded are just set as text type. They're not meant to be joined on these values.
 */

$cml = $modx->getService('commercemultilang', 'CommerceMultiLang', $modx->getOption('commercemultilang.core_path', null, $modx->getOption('core_path') . 'components/commercemultilang/') . 'model/commercemultilang/', $scriptProperties);
